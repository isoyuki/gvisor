...
func RegisterFlags(flagSet *flag.FlagSet) {
	...
	flagSet.Bool("experimental-sentry-ebpf", false, "EXPERIMENTAL. Enables sandbox-local eBPF in the sentry. Workload bpf(2) calls are not passed through to the host.")
